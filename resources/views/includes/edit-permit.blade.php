        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                    ...
                    <textarea class="form-control" name="location" style="text-align:right" id="exampleFormControlTextarea1" rows="3">{{$permit->location}}</textarea>
                    <br>
                    <label for="exampleFormControlTextarea1">وصف العمل</label>
                    <textarea class="form-control" name="desc" style="text-align:right" id="exampleFormControlTextarea1" rows="3">{{$permit->desc}}</textarea>
                    <br>
