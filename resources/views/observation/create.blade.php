...
<div >
    <div id="page-inner">
        <div class="form-style-5">
            ...
            <h1 class="page-subhead-line" style="text-align: right;">برجاء تعبئة النموذج التالي لارسال ملاحظة سلامة</h1>
            <form method="POST" action="{{route('observations.store')}}"  enctype="multipart/form-data" >
                ...
                <div class="form-group" style="text-align:right">
                    ...
                    <textarea class="form-control" style="text-align:right" name="desc" id="exampleFormControlTextarea1" rows="3"></textarea>

                    <label for="exampleFormControlInput1"> (الاسم(اختياري</label>
                    <input type="text" class="form-control" style="text-align:right" name="observer" id="exampleFormControlInput1">
