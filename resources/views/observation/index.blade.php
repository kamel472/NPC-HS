    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">شركة النصر للبترول
                بوابة</a>
            </div>
      ...
      <table class="table">
        ...
        @foreach($obs as $ob)
          ...
          <tr class="list-group-item-success">
            ...
            <td>{{$ob->title}}</td>
            <td>{{$ob->created_at}} </td>
            @if ($ob->status ==  'لم يتم الحل')
            <td><a href="#" class="btn btn-danger ">{{$ob->status}}</a></td>
            @else
            <td><a href="#" class="btn btn-primary ">{{$ob->status}}</a></td>
            @endif
          </tr>
          @endforeach
